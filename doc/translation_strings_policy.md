...
This document provides guidelines for internationalization of the Friendshipcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `friendshipcoin_en.ts` remains unchanged.

...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("0","54.174.152.228"));
        vSeeds.push_back(CDNSSeedData("1","nodeuseast.friendshipcoin.com"));
        vSeeds.push_back(CDNSSeedData("2","nodeuswest.friendshipcoin.com"));

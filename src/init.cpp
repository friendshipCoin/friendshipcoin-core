...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    if(hmm == HMM_FRIENDSHIPCOIND || hmm == HMM_FRIENDSHIPCOIN_QT)
    {
    ...
    if (hmm == HMM_FRIENDSHIPCOIND || hmm == HMM_FRIENDSHIPCOIN_CLI)
    {
